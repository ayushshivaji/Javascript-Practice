...
*/
function clearAll() {
    meme = document.querySelector('.show-a-meme');
    joke = document.querySelector('.tell-me-a-joke');
    quote = document.querySelector('.random-quote');
    riddle = document.querySelector('.riddle-me');
    meme.innerHTML = '';
    joke.innerHTML = '';
    quote.innerHTML = '';
    riddle.innerHTML = '';
  ...
  */
  function showMeme() {
    ...
    const randomMemeUrl = getRandomData('memes');
      const memeContainer = document.querySelector('.show-a-meme');
  ...
  */
  function showJoke() {
    ...
    jokeEle = document.querySelector(".tell-me-a-joke");
    jokeContainer = document.createElement("p")
    jokeContainer.textContent = randomJokeText;
    clearAll();
    jokeEle.appendChild(jokeContainer);
  }
  ...
  */
  function showQuote() {
    ...
    quoteContainer = document.querySelector(".random-quote");
  ...
  */
  function showRiddle() {
    ...
    riddleQuestion = document.createElement("p");
    riddleAnswer = document.createElement("p");
    
    riddleQuestion.textContent = randomRiddle.question;
    riddleAnswer.textContent = randomRiddle.answer;
    
    riddleAnswer.setAttribute('hidden','true');
    riddleAnswer.setAttribute('id','riddle-answer')
    
    riddleContainer = document.querySelector(".riddle-me");
  ...
  /**
  * TODO: Unhide the riddle's answe
  ...
  */
  function revealAnswers(answer) {
    riddleContainer = document.querySelector(".riddle-me");
    riddleAnswer = document.getElementById('riddle-answer');
    if(riddleAnswer == null){
      alert("No riddle on the window yet");
    }
    else if(riddleAnswer.hidden==false){
